    ...
    it('should handle removed tabs', () => {
      return new Promise(resolve => {
        fixtureEl.innerHTML = [
          ...
          '</ul>',
          '<div class="tab-content">',
          '  <div role="tabpanel" class="tab-pane fade show active" id="profile">test.html 1</div>',
          '  <div role="tabpanel" class="tab-pane fade" id="buzz">test.html 2</div>',
          '  <div role="tabpanel" class="tab-pane fade" id="references">test.html 3</div>',
          '</div>'
        ].join('')
  ...
  describe('data-api', () => {
    ...
    it('should add `show` class to tab panes if there is no `.fade` class', () => {
      return new Promise(resolve => {
        fixtureEl.innerHTML = [
          ...
          '</ul>',
          '<div class="tab-content">',
          '  <div role="tabpanel" class="tab-pane" id="home">test.html 1</div>',
          '  <div role="tabpanel" class="tab-pane" id="profile">test.html 2</div>',
          '</div>'
        ].join('')
    ...
    it('should add show class to tab panes if there is a `.fade` class', () => {
      return new Promise(resolve => {
        fixtureEl.innerHTML = [
          ...
          '</ul>',
          '<div class="tab-content">',
          '  <div role="tabpanel" class="tab-pane fade" id="home">test.html 1</div>',
          '  <div role="tabpanel" class="tab-pane fade" id="profile">test.html 2</div>',
          '</div>'
        ].join('')
    ...
    it('should prevent default when the trigger is <a> or <area>', () => {
      return new Promise(resolve => {
        fixtureEl.innerHTML = [
          '<ul class="nav" role="tablist">',
          '  <li><a type="button" href="#test.html"  class="active" role="tab" data-bs-toggle="tab">Home</a></li>',
