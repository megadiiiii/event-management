...
describe('ScrollSpy', () => {
  ...
  const testElementIsActiveAfterScroll = ({ elementSelector, targetSelector, contentEl, scrollSpy, cb }) => {
    ...
    setTimeout(() => { // in case we scroll something before the test.html
  ...
  describe('constructor', () => {
    ...
    it('should null, if element is not scrollable', () => {
      fixtureEl.innerHTML = [
        ...
        '</nav>',
        '<div id="content">',
        '  <div id="1" style="height: 300px;">test.html</div>',
        '</div>'
      ].join('')
    ...
    it('should not take count to not visible sections', () => {
      fixtureEl.innerHTML = [
        ...
        '  <div id="one" style="height: 300px;">test.html</div>',
        '  <div id="two" hidden style="height: 300px;">test.html</div>',
        '  <div id="three"  style="display: none;">test.html</div>',
        '</div>'
      ].join('')
    ...
    it('should not process element without target', () => {
      fixtureEl.innerHTML = [
        ...
        '</nav>',
        '<div id="content" style="height: 200px; overflow-y: auto;">',
        '  <div id="two" style="height: 300px;">test.html</div>',
    ...
    it('should not clear selection if above the first section and first section is at the top', () => {
      return new Promise(resolve => {
        fixtureEl.innerHTML = [
          ...
          '  <div id="one" style="height: 100px;">test.html</div>',
          '  <div id="two" style="height: 100px;">test.html</div>',
          '  <div id="three" style="height: 100px;">test.html</div>',
          '  <div id="spacer" style="height: 100px;">test.html</div>',
          '</div>'
        ].join('')
