...
describe('SelectorEngine', () => {
  ...
  describe('find', () => {
    ...
    it('should find elements globally', () => {
      fixtureEl.innerHTML = '<div id="test.html"></div>'

      const div = fixtureEl.querySelector('#test.html')

      expect(SelectorEngine.find('#test.html')).toEqual([div])
    })
  ...
  describe('findOne', () => {
    it('should return one element', () => {
      ...
      expect(SelectorEngine.findOne('#test.html')).toEqual(div)
    })
  })
  ...
  describe('prev', () => {
    it('should return previous element', () => {
      fixtureEl.innerHTML = '<div class="test.html"></div><button class="btn"></button>'

      const btn = fixtureEl.querySelector('.btn')
      const divTest = fixtureEl.querySelector('.test.html')

      expect(SelectorEngine.prev(btn, '.test.html')).toEqual([divTest])
    })
    ...
    it('should return previous element with comments or text nodes between', () => {
      ...
      const btn = fixtureEl.querySelector('.btn')
      const divTest = fixtureEl.querySelectorAll('.test.html')[1]
