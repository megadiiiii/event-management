...
describe('Util', () => {
  ...
  describe('getSelectorFromElement', () => {
    it('should get selector from data-bs-target', () => {
      fixtureEl.innerHTML = [
        '<div id="test.html" data-bs-target=".target"></div>',
        '<div class="target"></div>'
      ].join('')

      const testEl = fixtureEl.querySelector('#test.html')
    ...
    it('should get selector from href if data-bs-target equal to #', () => {
      fixtureEl.innerHTML = [
        '<a id="test.html" data-bs-target="#" href=".target"></a>',
        '<div class="target"></div>'
      ].join('')
    ...
    it('should return null if a selector from a href is a url without an anchor', () => {
      fixtureEl.innerHTML = [
        '<a id="test.html" data-bs-target="#" href="foo/bar.html"></a>',
        '<div class="target"></div>'
      ].join('')
    ...
    it('should return the anchor if a selector from a href is a url', () => {
      fixtureEl.innerHTML = [
        '<a id="test.html" data-bs-target="#" href="foo/bar.html#target"></a>',
        '<div id="target"></div>'
      ].join('')
    ...
    it('should return null if selector not found', () => {
      fixtureEl.innerHTML = '<a id="test.html" href=".target"></a>'
  ...
  describe('isElement', () => {
    it('should detect if the parameter is an element or not and return Boolean', () => {
      fixtureEl.innerHTML = [
        '<div id="foo" class="test.html"></div>',
        '<div id="bar" class="test.html"></div>'
      ].join('')
      ...
      expect(Util.isElement(fixtureEl.querySelectorAll('.test.html'))).toBeFalse()
    })
  ...
  describe('getElement', () => {
    it('should try to parse element', () => {
      ...
      expect(Util.getElement(fixtureEl.querySelectorAll('.test.html'))).toBeNull()
