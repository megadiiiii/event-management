...
describe('Config', () => {
  ...
  describe('mergeConfigObj', () => {
    it('should parse element\'s data attributes and merge it with default config. Element\'s data attributes must excel Defaults', () => {
      fixtureEl.innerHTML = '<div id="test.html" data-bs-test.html-bool="false" data-bs-test.html-int="8" data-bs-test.html-string1="bar"></div>'
      ...
      const configResult = instance._mergeConfigObj({}, fixtureEl.querySelector('#test.html'))
    ...
    it('should parse element\'s data attributes and merge it with default config, plug these given during method call. The programmatically given should excel all', () => {
      fixtureEl.innerHTML = '<div id="test.html" data-bs-test.html-bool="false" data-bs-test.html-int="8" data-bs-test.html-string-1="bar"></div>'
      ...
      const configResult = instance._mergeConfigObj({
        testString1: 'test',
        testInt: 3
      }, fixtureEl.querySelector('#test.html'))
    ...
    it('should parse element\'s data attribute `config` and any rest attributes. The programmatically given should excel all. Data attribute `config` should excel only Defaults', () => {
      fixtureEl.innerHTML = '<div id="test.html" data-bs-config=\'{"testBool":false,"testInt":50,"testInt2":100}\' data-bs-test.html-int="8" data-bs-test.html-string-1="bar"></div>'
    ...
    it('should omit element\'s data attribute `config` if is not an object', () => {
      fixtureEl.innerHTML = '<div id="test.html" data-bs-config="foo" data-bs-test.html-int="8"></div>'
